...
public class ProfileForm {
    ...
    public String getPprPolicy() {
        return pprPolicy;
    }

    public void setPprPolicy(String pprPolicy) {
        this.pprPolicy = pprPolicy;
    }
    ...
    public V3Support getV3Support() {
        return v3Support;
    }

    public void setV3Support(V3Support v3Support) {
        this.v3Support = v3Support;
    }
