...
CREATE TABLE `esim_business_record`  (
  ...
  INDEX `idx_eid`(`eid`) USING BTREE,
  INDEX `idx_match_id`(`match_id`) USING BTREE,
  INDEX `idx_create_time`(`create_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '业务记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `esim_cert`  (
  ...
  INDEX `idx_cipkid`(`cipkid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '证书管理表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `esim_mon`  (
  ...
  `mon_short_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '简称',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_mon_oid`(`mon_oid`) USING BTREE,
  INDEX `idx_mon_name`(`mon_name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '运营商管理表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `esim_profile`  (
  ...
  `profile_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'Available' COMMENT 'Profile状态：Available, Allocated, Linked, Confirmed, Released, Downloaded, Installed, Error, Unavailable',
  `notification_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'Enabled' COMMENT '通知状态：Enabled, Disabled, Deleted',
  ...
  `carrier` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '运营商：中国移动, 中国联通, 中国电信, 中国广电',
  ...
  `adm1` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'ADM1',
  `ki` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'KI密钥',
  `opc` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'OPC密钥',
  `smsp` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'SMSP',
  `v3_features` json NULL COMMENT 'V3功能支持：rpmData-RPM数据, deviceSwitchData-设备切换数据, enterpriseProfileData-企业Profile数据',
  `rpm_type` json NULL COMMENT 'RPM类型：Enable, Disable, Delete, ListProfileInfo, ContactPcmp',
  `rpm_download_method` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'RPM下载方式：SM-DP+, SM-DS',
  ...
  `allowed_tags` json NULL COMMENT '允许的Tags (JSON数组)',
  ...
  `device_switch_allowed_ca` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '设备切换允许的CA：CA1, CA2, CA3',
  `enterprise_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '企业名称',
  `enterprise_rules` json NULL COMMENT '企业规则 (JSON数组)：priorityEnterpriseProfile-优先级企业Profile, onlyInstallEnterpriseProfile-只能安装企业Profile',
  ...
  UNIQUE INDEX `uk_matching_id`(`matching_id`) USING BTREE,
  INDEX `idx_profile_status`(`profile_status`) USING BTREE,
  INDEX `idx_notification_status`(`notification_status`) USING BTREE,
  INDEX `idx_tenant`(`tenant`) USING BTREE,
  INDEX `idx_carrier`(`carrier`) USING BTREE,
  INDEX `idx_reset_rule`(`reset_rule`) USING BTREE,
  INDEX `idx_download_method`(`download_method`) USING BTREE,
  INDEX `idx_profile_class`(`profile_class`) USING BTREE,
  INDEX `idx_create_time`(`create_time`) USING BTREE,
  INDEX `idx_update_time`(`update_time`) USING BTREE,
  INDEX `idx_del_flag`(`del_flag`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'eSIM Profile完整信息表 - 基于ProfileForm.vue完整数据结构' ROW_FORMAT = Dynamic;
...
CREATE TABLE `esim_tempdate`  (
  ...
  INDEX `idx_mon_id`(`mon_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '模板管理表' ROW_FORMAT = Dynamic;
